...
//		str.append(code);
    ...
    public String getCode(AirConditionerData airConditionerData) {
        ...
        stringBuilder.append(",");
        stringBuilder.append("上下");
        stringBuilder.append(airConditionerData.verticalScavenging ? "开" : "关");
        stringBuilder.append(",");
        stringBuilder.append("左右");
        stringBuilder.append(airConditionerData.verticalScavenging ? "开" : "关");
        return getGreeFrequency(stringBuilder.toString());
    }
